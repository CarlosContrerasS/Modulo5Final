...
<table id="example" class="row-border" style="width:50%">
    ...
    <tbody>
		...
		<td >
			...
			<a href="eliminarempleado?RutEmpleado=${empleado.getRutEmpleado()}">Eliminar</a>&nbsp;
			<a href="editarempleado?RutEmpleado=${empleado.getRutEmpleado()}">Editar</a>&nbsp;
			<a href="veractividades?rutempleado=${empleado.getRutEmpleado()}">Ver Actividades</a>&nbsp;
