...
<h3>Ingrese el Rut del Cliente y el suyo por favor</h3>

<form method="get" action="vercliente" style="margin-bottom: 3%;">
              Busqueda por Rut Cliente: <input type="search" name="rut" placeholder="Rut sin puntos ni guión."> <br>
              
              Busqueda por Rut Profesional: <input type="search" name="rutempleado" placeholder="Rut sin puntos ni guión."><br>
          
              <input type="submit" name = "Buscar" value="Buscar">
</form>
</div>

<h3 style="text-align: center">Verifique los datos ingresados</h3>
<br>
<h2 style="text-align: center"> Datos del Clientes</h2>
<table id="example" class="row-border" style="width:70%; text-align: center; margin:2% 25%">
	<tr>
		<th>Rut</th>
		<th>Nombre</th>
		<th>Rubro</th>
	...
	<h3 id ="titulo"> Visitas Realizadas</h3>
	<h3 id ="titulo">${cantidadvisitas}</h3>
	<br><br>
	...
	<c:forEach items="${visitasfechas}" var="fechas">
		<tbody>
		<tr>
			<td>${fechas}</td>
		</tr>
  ...
  <br><br>
	...
	<h3 id ="titulo"> Asesorias Realizadas</h3>
	<h3 id ="titulo">${cantidadasesorias}</h3>
	<br><br>
	...
	<c:forEach items="${asesoriasfechas}" var="fechas">
		<tbody>
		<tr>
			<td>${fechas}</td>
		</tr>
