...
<h1 id="titulo">Reporte Global </h1>
</div>
<table id="example" class="row-border" style="width:70%; margin:0% 10%">
	<tr>
		<th>Cantidad de Clientes</th>
		</tr>
		<tr>
		<td>${reporte.getCantidadClientes()}</td>
		</tr>
		<tr>
		...
		<tr>
			<td>${reporte.getTotalDiasPerdidos()}</td>
			<td>${reporte.getTotalTrabajoresAccidentados()}</td>
			<td>${reporte.getCantidadDeAccidentes()}</td>
		</tr>
		</table>
		...
		<tr>	
			...
			<th>Asistentes a Capacitaciones</th>
		</tr>
		<tr>
			<td>${reporte.getCantidadDeVisitas()}</td>
			<td>${reporte.getCantidadDeAsesorias()}</td>
			<td>${reporte.getCantidadDeCapacitaciones()}</td>
			<td>${reporte.getCantidadDeMejoras()}</td>
			<td>${reporte.getCantidadDeAsistentesCapacitaciones()}</td>
		</tr>
		</table>
		<table  class="row-border" style="width:50%; margin:2% 25%; text-align: center">
		<tr>
			...
			<th>Total Pagos Regulares</th>
			<th>Total Pagos Adicionales</th>
		</tr>
		<tr>
			<td>${reporte.getTotalRegular()}</td>
			<td>${reporte.getTotalAdicional()}</td>
		</tr>
</table>
