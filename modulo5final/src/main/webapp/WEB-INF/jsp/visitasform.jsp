...
<a style="margin:0% 1%">Cerrar Sesion</a> <input type=image src="<c:url value="/resources/img/exit.svg"/>" onclick="logout" style="margin:0% 10% 0% 0%; width: 2%;">
	...
	<div id="titulo">
	         <a><img src="<c:url value="/resources/img/building.svg"/>" title="Ingreso Accidentes" style="width: 10%;"></img></a>
...
<div>
<form method="get" action="buscarrutes" style="margin-bottom: 3%;">
              Busqueda Rut Cliente: <input type="search" name="rut" placeholder="Rut sin puntos ni guión">
              
              Busqueda Rut Profesional: <input type="search" name="rutempleado" placeholder="Ingrese el rut sin puntos ni guión">
...
<div>
<form method="post" action="guardarvisitas">
	
	<h3>Verifique los datos por favor.</h3>
	
	<label for="rut"> Rut del Cliente :</label>
    <input type="text" class="campo_formulario" name="rut" value="${cliente.getRut()}"  style="width : 20%"/><br/>
    <label for="nombre">Nombre del Cliente :</label>
    <input type="text" class="campo_formulario" name="nombre" value="${cliente.getNombre()}" style="width : 20%"/><br/>
    
    <label for="rutempleado">Rut del Profesional :</label>
    <input type="text" class="campo_formulario" name="rutempleado" value="${empleado.getRutEmpleado()}" style="width : 20%"/><br/>
    <label for="nombreempleado">Nombre del Profesional :</label>
    <input type="text" class="campo_formulario" name="nombreempleado" value="${empleado.getNombreEmpleado()}" style="width : 20%"/><br/><br/>
    
    <h3>Complete el formulario por favor.</h3>
    
	fecha: <input type="text" class="campo_formulario"  name="Fecha"  style="width : 20%" /><br/>
	Direccion: <input type="text" class="campo_formulario" name="Direccion" /><br/>
	Ciudad: <input type="text" class="campo_formulario" name="Ciudad" /><br/>
	Resumen: <input type="text" class="campo_formulario"  name="Resumen" /><br/>
	Observaciones: <input type="text" class="campo_formulario" name="Observaciones"/><br/>
	
	<input type="hidden" name="rut" value="${cliente.getRut()}" />
	<input type="hidden" name="rutempleado" value="${empleado.getRutEmpleado()}"/>
