...
<table id="example" class="row-border" style="width:40%">
	...
	<c:forEach items="${lclientes}" var="cliente">
	<tbody>
	<tr>
		...
		<td>
			...
			<a href="eliminarcliente?Rut=${cliente.getRut()}">Eliminar</a>&nbsp;
			<a href="editarcliente?Rut=${cliente.getRut()}">Editar</a>&nbsp;
	</tr>
	</tbody>
</c:forEach>
</table>
