...
<a style="margin:0% 1%">Cerrar Sesion</a> <input type=image src="<c:url value="/resources/img/exit.svg"/>" onclick="logout" style="margin:0% 10% 0% 0%; width: 2%;">
  ...
  <div class="contenedor_img_box col-s-12 col-l-12 col-12" style="background-color: #f8c623; border-radius: 30px; width: 80%; text-align: center; padding: 5%; margin: 1rem;">
  <img src="<c:url value="/resources/img/warning.svg"/>" style="widht:100%; margin:0% 0% 2% 0%">
                    <h1>Ups!</h1>
                    <h2>El perfil no tiene suficientes provilegios para acceder a esta sección, por favor póngase en contacto con el administrador</h2>
