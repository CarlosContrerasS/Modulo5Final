...
<h1 id="titulo"><a href="./img/schedule.svg" style="width: 50%;">Mostrar Check List Ingresados</a></h1>
<br><br><br><br>
<table id="example" class="row-border" style="width:50%">
	...
	<c:forEach items="${lchequeo}" var="chequeo">
	<tr>
		<td>${chequeo.getIDChequeo()}</td>
		<td>${chequeo.getDetalle()}</td>
		<td>${chequeo.getEstado()}</td>
		<td>${chequeo.getVisitasfk().getRutfk().getRut()}</td>
