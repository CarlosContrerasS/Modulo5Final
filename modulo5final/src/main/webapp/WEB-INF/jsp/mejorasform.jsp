...
<h1 id="titulo">Agregar Mejoras</h1><br>
<c:if test="${ccmensaje != null}">
	<h3><c:out value="${ccmensaje}"></c:out></h3>
</c:if>

<form method="get" action="findbuscaridv" style="margin-bottom: 3%;">
<h3>Ingresa los datos de la busqueda por favor.</h3>
...
<form method="post" action="guardarmejoras">
			...
			<input type="text" class="campo_formulario" name="estado" /><br /> <br /> 
