...
<a style="margin:0% 1%">Cerrar Sesion</a> <input type=image src="<c:url value="/resources/img/exit.svg"/>" onclick="logout" style="margin:0% 10% 0% 0%; width: 2%;">
            ...
            <div class="formulario">
                <form method="post" action="guardarusuario">
                    ...
                    <input type="text" class="campo_formulario" name="Login"/><br/>
                    <label for="Clave">Clave </label><br/>
                    <input type="text" class="campo_formulario" name="Clave" /><br/>
                    <label for="Rol">Rol </label><br/>
                    <input type="text" class="campo_formulario" name="Rol" /><br/>
