...
<a style="margin:0% 1%">Cerrar Sesion</a> <input type=image src="<c:url value="/resources/img/exit.svg"/>" onclick="logout" style="margin:0% 10% 0% 0%; width: 2%;">
            ...
            <div id="titulo">
                <a><img src="<c:url value="/resources/img/clipboard.svg"/>" title="Ingreso Accidentes" style="width: 10%;"></img></a>
            <h1>Creacion de Check List</h1><br>
            <h3>Verifique el ID de Visita Asociado</h3>
        </div>
        
        <form method="get" action="findvis" style="margin-bottom: 3%;">
              Busqueda ID Visita: <input type="search" name="idvisita" placeholder=" Idvisita">
            ...
            <div class="formulario">
                ...
                <form method="post" action="guardarchequeo">
                
                	<h3>Vefirique el ID de Visita Ingresado</h3>
                	<label for="idvisita">Id Visita :</label>
   					 <input type="text" class="campo_formulario" name="idvisita" value="${visitas.getIdvisita()}"/><br/>
                    
                    <h3>Complete los datos por favor</h3>
                    <label for="detalle">Detalle </label>
                    <input type="text" class="campo_formulario" name="detalle"/><br/>
                    <label for="estado">Estado </label>
                    <input type="text" class="campo_formulario" name="estado"/><br/>
                    
                    <input type="hidden" name="idvisita" value="${visitas.getIdvisita()}" />
                    
                    <input type="submit" value="Agregar chequeo" />
                </form>
        </div>
        <footer>
