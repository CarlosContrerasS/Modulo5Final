...
<a style="margin:0% 1%">Cerrar Sesion</a> <input type=image src="<c:url value="/resources/img/exit.svg"/>" onclick="logout" style="margin:0% 10% 0% 0%; width: 2%;">
        ...
        <div id="titulo">
            <a><img src="<c:url value="/resources/img/engineer-delete.svg"/>" title="Ingreso Profesional" style="width: 10%;"></img></a>
            <h1>Eliminar Profesional</h1>
            <h3 style="margin-bottom: 3%;">Por favor, ingrese el RUT sin puntos y guion</h3>
        </div>
          <form method="get" action="detalleempleado" style="margin-bottom: 3%;">
            ...
            <div class="formulario" >
                ...
                <form method="get" action="eliminarempleado">
                	...
                	<label for="rutempleado">Rut </label><br/>
                    <input type="text" class="campo_formulario" name="RutEmpleado" value="${empleado.getRutEmpleado()}"/><br/>
                    
                    <label for="nombreempleado">Nombre Empleado </label><br/>
                    <input type="text" class="campo_formulario" name="Nombre" value="${empleado.getNombreEmpleado()}"/><br/>
                    <label for="especialidad">Telefono </label><br/>
                    <input type="text" class="campo_formulario" name="Especialidad" value="${empleado.getEspecialidad()}" /><br/>
