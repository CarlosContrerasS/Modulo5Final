...
<a style="margin:0% 1%">Cerrar Sesion</a> <input type=image src="<c:url value="/resources/img/exit.svg"/>" onclick="logout" style="margin:0% 10% 0% 0%; width: 2%;">
	...
	<div id="titulo">
	                <a><img src="<c:url value="/resources/img/presentation.svg"/>" title="Ingreso Accidentes" style="width: 10%;"></img></a>
		<h1>Creacion de Capacitacion</h1>
		<h3>Por favor, llene todos los campos del formulario</h3>
	</div>

	<form method="get" action="buscaridvisita" style="margin-bottom: 3%;">
		Busqueda id por Visita: <input type="search" name="Idvisita" placeholder="Idvisita."> 
		<input type="submit" value="Buscar">
	</form>
	<div class="formulario">

		<form method="post" action="guardarcapacitaciones">
