...
<h1 id ="titulo">Agregar Asesoria Especial</h1><br>
<h2 id ="titulo">Esta Asesoria Tiene un Costo Asociado</h2>

<form method="get" action="buscarid" style="margin-bottom: 3%;">
              Busqueda id por Visita: <input type="search" name="Idvisita" placeholder="idVisita.">
...
<form method="post" action="guardarasesoria">
    ...
    <input type="text" class="campo_formulario" name="nombre" value="${visitas.getVisitasfk().getRutfk().getNombre()}"/><br/>
	...
	<input type="hidden" name="id" value="${visitas.getIdvisita()}" />
