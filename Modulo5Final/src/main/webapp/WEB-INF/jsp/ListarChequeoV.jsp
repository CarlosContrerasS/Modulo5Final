...
<h1 id="titulo"><a href="./img/schedule.svg" style="width: 50%;">Mostrar Chek List Ingresados</a></h1>
<br><br><br><br>
<table id="example" class="row-border" style="width:50%">
	...
	<c:forEach items="${listache}" var="chequeo">
	<tr>
		<td>${chequeo.getDetalle()}</td>
		<td>${chequeo.getEstado()}</td>
		<td>${chequeo.getVisitas_IDVisita()}</td>
